...
{
    class DataLieuxChildren
    {

        public DataLieuxChildren()
        {
        ...
        public Lieu Couloir = new Lieu(4, 5, 5, "un couloir", "un long couloir étroit", DataMonsters.GetFirstFloorMonsters());
        ...
        public Lieu Fontaine = new Fountaine();
    ...
    {
        int actionNumber = 1;
        public Fountaine2() : base(1, 2, 7, 1,"Fontaine", null, null, false, true, true)
        {
